...
\textbf{Response.} We traced the collection back to the original loader and acquisition log. The original local analysis inventory retained all 27 seizure-containing recordings in the five configured cases and 43 of their 148 EDFs without annotated seizures. The remaining 105 EDFs had not been included on the basis of a documented quality criterion. We therefore revised the collection account to distinguish the original local inventory from the complete set of available recordings.
